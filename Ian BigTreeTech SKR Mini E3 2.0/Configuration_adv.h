 ...
 */
//#define USE_CONTROLLER_FAN //Ian comentado para usar controlador manual.
 ...
 */
#define INPUT_SHAPING_X //Ian
#define INPUT_SHAPING_Y //Ian
#if EITHER(INPUT_SHAPING_X, INPUT_SHAPING_Y)
  #if ENABLED(INPUT_SHAPING_X)
    #define SHAPING_FREQ_X  58          //Ian // (Hz) The default dominant resonant frequency on the X axis.
    #define SHAPING_ZETA_X  0.15f       //Ian // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Y)
    #define SHAPING_FREQ_Y  39          //Ian // (Hz) The default dominant resonant frequency on the Y axis.
    #define SHAPING_ZETA_Y  0.07f       //Ian // Damping ratio of the Y axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  //#define SHAPING_MIN_FREQ  20.0      // (Hz) By default the minimum of the shaping frequencies. Override to affect SRAM usage.
  //#define SHAPING_MAX_STEPRATE 10000  // By default the maximum total step rate of the shaped axes. Override to affect SRAM usage.
  #define SHAPING_MENU                  //Ian // Add a menu to the LCD to set shaping parameters.
#endif
 ...
 */
#define LIN_ADVANCE //Ian
#if ENABLED(LIN_ADVANCE)
  #if ENABLED(DISTINCT_E_FACTORS)
    #define ADVANCE_K { 0.22 }    // (mm) Compression length per 1mm/s extruder speed, per extruder
  #else
    #define ADVANCE_K 0.22        // (mm) Compression length applying to all extruders//ABS Plastar Boquilla 0.5 = 0.37 //Ian
  #endif
 ...
 */
   ...
   */
  //#define SENSORLESS_HOMING // StallGuard capable drivers only//Ian TODO: Revisar de habilitarlo

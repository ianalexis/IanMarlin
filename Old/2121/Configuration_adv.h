...
#define INPUT_SHAPING_Y //Ian 
    ...
    #define SHAPING_FREQ_X  32          //Ian // (Hz) The default dominant resonant frequency on the X axis.
    #define SHAPING_ZETA_X  0.15f       // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Y)
    #define SHAPING_FREQ_Y  35          //Ian // (Hz) The default dominant resonant frequency on the Y axis.
    #define SHAPING_ZETA_Y  0.30f       //Ian // Damping ratio of the Y axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
...
#define LIN_ADVANCE //Ian
    ...
    #define ADVANCE_K { 0.24 }    // (mm) Compression length per 1mm/s extruder speed, per extruder //Ian defecto 0.22
  #else
    #define ADVANCE_K 0.24        // (mm) Compression length applying to all extruders //Ian defecto 0.22
  #endif
  //#define ADVANCE_K_EXTRA       // Add a second linear advance constant, configurable with M900 L.
  //#define LA_DEBUG              // Print debug information to serial during operation. Disable for production use.
  #define EXPERIMENTAL_SCURVE   // Allow S-Curve Acceleration to be used with LA. //Ian

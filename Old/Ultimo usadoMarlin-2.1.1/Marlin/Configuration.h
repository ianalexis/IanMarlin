...
#define STRING_CONFIG_H_AUTHOR "(TitanBoreal, Dust, valerionew, Ender-3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 4.2.2 TitanBoreal"
...
#define BED_MAXTEMP      300 // 300 SOLO PARA TESTING. DEVOLVER A 135
